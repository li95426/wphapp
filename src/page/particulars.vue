<template>
  <div>
    ...
    <wph-particular-add-carts :particulars="particularsList"></wph-particular-add-carts>
...
<script>
  ...
  import particulars from "../../mock/particulars.json"
  import area from  "../../mock/area.json"
    export default {
      name: "particulars",
      components:{
        WphParticularPicbox,
